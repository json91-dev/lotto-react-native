...
// 로또 번호 검색
export const GET_WINNING_NUMBER_REQUEST = "GET_WINNING_NUMBER_REQUEST";
export const GET_WINNING_NUMBER_SUCCESS= "GET_WINNING_NUMBER_SUCCESS";
export const GET_WINNING_NUMBER_FAILURE= "GET_WINNING_NUMBER_FAILURE";
