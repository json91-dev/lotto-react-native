...
if (config.ENV === 'development') {
  ...
  bannerId = 'ca-app-pub-4400769153197740/6845680922';
} else if (Platform.OS === 'ios') {
  bannerId = 'ca-app-pub-4400769153197740/7391394265';
}
...
const MapBottom = (props) => {
  ...
  if (isEmptyCurrentStore) {
    return (
      <View style={{ width: '100%', height: 136, flexDirection: 'column-reverse', position: 'absolute', bottom: 0}}>
        <View>
